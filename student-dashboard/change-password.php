...
$sql ="SELECT * FROM student WHERE id='$session_student_id' AND password='$password'";
$run=mysqli_query($conn,$sql);
    
if(mysqli_num_rows($run)>0)
{
$change_query="UPDATE `student` SET `password` = '$newpassword' WHERE `student`.`id` = $session_student_id";
